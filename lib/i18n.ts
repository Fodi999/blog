...
export const copy = {
  ...
  en: {
    ...
    shop: { eyebrow: 'Chef selected', title: 'Shop', lead: 'Objects and products with a clear purpose in a good kitchen.', empty: 'The shop is being prepared. Active products will appear here automatically.', ask: 'Ask about product', priceOnRequest: 'Price on request', inStock: 'In stock', categories: 'categories' },
    about: {
  ...
  ru: {
    ...
    shop: { eyebrow: 'Выбор шефа', title: 'Магазин', lead: 'Предметы и продукты с конкретной ролью на хорошей кухне.', empty: 'Магазин готовится. Активные товары появятся здесь автоматически.', ask: 'Спросить о товаре', priceOnRequest: 'Цена по запросу', inStock: 'В наличии', categories: 'категорий' },
    about: {
  ...
  uk: {
    ...
    shop: { eyebrow: 'Вибір шефа', title: 'Магазин', lead: 'Предмети та продукти з конкретною роллю на хорошій кухні.', empty: 'Магазин готується. Активні товари з’являться тут автоматично.', ask: 'Запитати про товар', priceOnRequest: 'Ціна за запитом', inStock: 'В наявності', categories: 'категорій' },
    about: {

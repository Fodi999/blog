    ...
    <main className="max-w-7xl mx-auto space-y-12 md:space-y-16 px-4 sm:px-6 py-8 md:py-12">
      ...
      <section className="space-y-6 md:space-y-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className="text-xs md:text-sm text-muted font-mono">v2.1.0 • Production Ready</span>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          <div className="p-4 md:p-6 rounded-xl border-2 border-border bg-card space-y-2">
            ...
            <p className="text-xs md:text-sm text-muted">{t('metrics.implementationDesc')}</p>
          </div>
          ...
          <div className="p-4 md:p-6 rounded-xl border-2 border-border bg-card space-y-2">
            ...
            <p className="text-xs md:text-sm text-muted">{t('metrics.languagesDesc')}</p>
          </div>
          ...
          <div className="p-4 md:p-6 rounded-xl border-2 border-border bg-card space-y-2">
            ...
            <p className="text-xs md:text-sm text-muted">{t('metrics.hostingDesc')}</p>
          </div>
          ...
          <div className="p-4 md:p-6 rounded-xl border-2 border-border bg-card space-y-2">
            ...
            <p className="text-xs md:text-sm text-muted">{t('metrics.mobileDesc')}</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6 md:space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          {/* Feature 1: Menu */}
          <div className="p-6 md:p-8 rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-red-500/5 to-orange-500/5 space-y-4">
          ...
          {/* Feature 2: Cart */}
          <div className="p-6 md:p-8 rounded-2xl border-2 border-green-500/20 bg-gradient-to-br from-green-500/5 to-blue-500/5 space-y-4">
            <div className="flex items-center gap-3">
          ...
          {/* Feature 3: Delivery */}
          <div className="p-6 md:p-8 rounded-2xl border-2 border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-purple-500/5 space-y-4">
            <div className="flex items-center gap-3">
          ...
          {/* Feature 4: Tracking */}
          <div className="p-6 md:p-8 rounded-2xl border-2 border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-pink-500/5 space-y-4">
            <div className="flex items-center gap-3">
      ...
      <section className="space-y-6 md:space-y-8 bg-gradient-to-br from-gray-500/5 to-gray-500/5 rounded-2xl md:rounded-3xl p-6 md:p-12 border border-border">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="p-4 md:p-6 rounded-xl bg-white/50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-800/30 space-y-2">
              <h4 className="text-base md:text-lg font-bold text-foreground">{t(`tech.stack${i}.title`)}</h4>
              <p className="text-xs md:text-sm text-muted">{t(`tech.stack${i}.description`)}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="space-y-6 md:space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          <div className="p-6 md:p-8 rounded-xl border-2 border-border bg-card hover:border-primary/30 transition-colors space-y-4">
            ...
            <p className="text-xs md:text-sm text-muted">{t('why.point1.description')}</p>
          </div>
          ...
          <div className="p-6 md:p-8 rounded-xl border-2 border-border bg-card hover:border-primary/30 transition-colors space-y-4">
            ...
            <p className="text-xs md:text-sm text-muted">{t('why.point2.description')}</p>
          </div>
          ...
          <div className="p-6 md:p-8 rounded-xl border-2 border-border bg-card hover:border-primary/30 transition-colors space-y-4">
            ...
            <p className="text-xs md:text-sm text-muted">{t('why.point3.description')}</p>
          </div>
        </div>
      </section>

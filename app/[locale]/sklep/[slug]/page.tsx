  ...
  return (
    <article className="product-page">
      <ViewItemTracker item={{
        ...
        item_name: name,
        item_category: categoryName(category, locale),
      ...
      <div className="product-page__info">
        ...
        <a className="button button--dark" href={`mailto:kontakt@dima-fomin.pl?subject=${encodeURIComponent(name)}`} data-ga-event="lead_form_submit" data-ga-label="shop_product_email" data-ga-item-id={product.slug} data-ga-item-name={name} data-ga-item-category={categoryName(category, locale)} data-ga-currency={product.currency} data-ga-value={product.price_cents ? product.price_cents / 100 : undefined}>{t.shop.ask}</a>
      </div>
    </article>
  );
}

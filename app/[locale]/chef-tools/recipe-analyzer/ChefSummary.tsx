...
const ISSUE_PHRASES: Record<string, Record<string, string>> = {
  ...
  low_fat:                { en: 'not enough fat', pl: 'za mało tłuszczu', ru: 'мало жиров', uk: 'мало жирів' },
  low_sweetness:          { en: 'lacks sweetness', pl: 'brakuje słodyczy', ru: 'не хватает сладости', uk: 'бракує солодкості' },
  low_bitterness:         { en: 'lacks bitter contrast', pl: 'brak gorzkiego kontrastu', ru: 'не хватает горечи', uk: 'бракує гіркоти' },
  missing_aromatics:      { en: 'no aromatic herbs or spices', pl: 'brak aromatycznych ziół', ru: 'нет ароматных трав и специй', uk: 'немає ароматних трав і спецій' },
  missing_acid_source:    { en: 'no acidity source', pl: 'brak źródła kwasowości', ru: 'нет источника кислотности', uk: 'немає джерела кислотності' },
